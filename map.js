...
fetch('data/countries.geojson')
  ...
  // var marker = L.marker([space.loc.lat, space.loc.long]).addTo(map);
  // marker.bindPopup('<a href="' + space.link.url + '" target="_blank"><h2>' + space.name + '</h2></a>'+ space.loc.street + '<br><b>' + space.loc.plz + ' ' + space.loc.city + '</b><br>'+space.loc.country+'<br><hr><a href="'+space.link.url+'" target="_blank"><b>'+space.link.text+'</b></a>');
